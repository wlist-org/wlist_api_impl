...
public enum Share {;
     ...
     */
    public static NetworkFuture<ShareInformation> share(final CoreClient client, final String token, final List<FileLocation> files, final boolean requirePassword, final String optionalPassword) { return Main.future(); }
}
