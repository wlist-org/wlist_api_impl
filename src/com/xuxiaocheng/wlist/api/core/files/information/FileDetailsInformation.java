 ...
 */
public record FileDetailsInformation(FileInformation basic, List<String> path, String optionalMd5, DownloadConfirmation optionalThumbnail) implements Serializable, Recyclable {
}
