...
public class MarkTest {
    ...
    public void commonAPI() {
        Assertions.assertEquals("1.0.0", Marks.COMMON_API_VERSION);
        Assertions.assertEquals("0.1.0", Marks.COMMON_IMPL_VERSION);
    }

    @Test
    public void coreAPI() {
        Assertions.assertEquals("1.0.1", Marks.CORE_API_VERSION);
        Assertions.assertEquals("0.1.0", Marks.CORE_IMPL_VERSION);
    }

    @Test
    public void webAPI() {
        Assertions.assertEquals("0.2.0", Marks.WEB_API_VERSION);
